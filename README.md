...
*Disclaimer:*
The actual project is based on ESP32 coupled with ATmega2560 mounted on custom designed PCB for optimized and enhanced operation. The above code with slight modifications can be used as it is with ESP8266(ESP - 01) and ATmega328P (Uno/Nano). I won't include long licence agreements, as this is my tiny bit of help to the community thought try not o get me in trouble! ;)
